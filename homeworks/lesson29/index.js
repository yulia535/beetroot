...
const hours = Number(prompt("Вкажіть час за який хочете дістатися в хвилинах?"));

if ((Number.isNaN(distance) === false && distance >0) && (Number.isNaN(hours) === false && hours >0)){ 
    //запитуємо тип змінної, яку приводимо до числа, якщо обидві змінні число - виконуємо
    console.log('Швидкість з якою вам потрібно рухатися ' + (distance/(hours/60)) + 'км/год');
} else {
